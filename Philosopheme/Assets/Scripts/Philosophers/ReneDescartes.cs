...
public class ReneDescartes : npc
{
    ...
    public override void InteractionTree()
    {
        ...
        Text("Здесь ты можешь найти все ответы, встретившись с ними лицом к лицу. Здравый смысл тебя направит.");
        BlockC();
        ...
        Text("В помощь тебе я дам базовую вещь, которая является первым шагом к познанию - сомнение.");
        BlockC();
